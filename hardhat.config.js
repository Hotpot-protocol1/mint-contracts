...
const { INFURA_MAINNET_API, STAGE, MNEMONIC, INFURA_GOERLI_API } = process.env;
...
task("sigverify", "Verify pending amounts", async (taskArgs, hre) => {
  const sig =
    "0x2c706b13d7194f5f6302a2e587d0d4582560d8f17111f05b59e8067047756a00354be8be844bf72c2197827e5b3f80fa35dd6111bb0e5dbe2f0895d201c358921c";
  const value = {
    offererPendingAmount: 0,
    buyerPendingAmount: 0,
    orderHash:
      "0xef5d923c3a25e3f22c219350cd9ae30b3a25e19cd471d0aa7f54112af379eea2",
  };
  ...
  const signer = hre.ethers.verifyTypedData(
    domain,
    pendingAmountType,
    value,
    sig
...
task(
  "fulfillorder-gas-est",
  "Estimate gas limit for a fulfill order tx",
  async (taskArgs, hre) => {
    /* 
   ...
   */
    const params = {
      ...
      pendingAmountsData: {
        ...
        buyerPendingAmount: 0,
        orderHash:
          "0x001f91851b722ddad7675feee5f547c12932147f21e9373c163a3651ce70c157",
      },
      salt: 122,
      orderSignature:
        "0xf49b7e4740cb47dfaafdd0f23a53f081ed4dfb73815ad99245c61ae47e86b39629205eaff584435abf05bbf370f76ea98c1ab77dddcca91c84ce61f55cbcc5d61c",
      pendingAmountsSignature:
        "0xb327ad3c18b6c6fe7171be94f7cab9797acade6c03016837544065c2eb1b008d69e9847acc545189ba29d6c9523ba06cfcaba75b5bf84f45df3d26c5554c59aa1b",
    };
    // call
